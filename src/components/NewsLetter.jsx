...
const NewsLetter = () => {
  return (
    <div className='w-full flex justify-center flex-col items-center relative pt-10 -bottom-32 bg-[#B8F4F3] px-24 '>
      <div>
      <Lottie loop={true} animationData={newsletter} className="w-40" />
      </div>
     <div className='text-center'>
      <h2 className='text-3xl pt-16  font-bold font-fajila'>Subscribe DrawNest, for getting update</h2>
